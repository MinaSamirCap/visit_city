...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        ...
        child: Consumer<ApiManager>(builder: (ctx, apiManager, _) {
          print("mustLogout: ${apiManager.mustLogout}");
          if (apiManager.mustLogout) {
            return authApp();
          } else {
            return visitFayoumApp(apiManager, ctx);
          }
        }));
  }

  MaterialApp visitFayoumApp(ApiManager apiManager, BuildContext ctxx) {
    return MaterialApp(
